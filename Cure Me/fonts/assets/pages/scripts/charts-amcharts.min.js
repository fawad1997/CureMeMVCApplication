var ChartsAmcharts = function () {
    ...
    t = function () {
        var e = AmCharts.makeChart("chart_2", {
            type: "serial", theme: "light", fontFamily: "Open Sans", color: "#888888", legend: {
    ...
    a = function () {
        var e = AmCharts.makeChart("chart_3", {
            type: "serial", theme: "light", fontFamily: "Open Sans", color: "#888888", pathToImages: App.getGlobalPluginsPath() + "amcharts/amcharts/images/", dataProvider: [{
                lineColor: "#b7e021", date: "2012-01-01", duration: 408
            }
            , {
            ...
            , {
                lineColor: "#fbd51a", date: "2012-01-05", duration: 501
            }
            , {
            ...
            , {
                date: "2012-01-08", duration: 309, lineColor: "#2498d2"
            }
            , {
    ...
    i = function () {
        var e = AmCharts.makeChart("chart_6", {
            ...
            ], valueField: "litres", titleField: "country", exportConfig: {
                menuItems: [{
                    icon: App.getGlobalPluginsPath() + "amcharts/amcharts/images/export.png", format: "png"
                }
                ]
